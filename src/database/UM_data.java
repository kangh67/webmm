...
public class UM_data {
	...
	public static String targetFile = "C:\\Users\\hkang1\\Google Drive\\AHRQ\\WEBMM\\raw\\UM_fall.txt";
	...
	public static ArrayList<ArrayList<String>> readFile() throws BiffException, IOException{
		...
		for(int i=1; i<line_rf; i++) {
			...
			thisInfo.add("MCPS" + sheet.getCell(0,i).getContents().trim());	//0: uni_id
			thisInfo.add("MCPS" + sheet.getCell(0,i).getContents().trim());	//1: title = uni_id
