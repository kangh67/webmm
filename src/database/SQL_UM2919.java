...
public class SQL_UM2919 {
	/**
	 * transfer the fall data from University of Missouri to another xls file which will be used to put into our database
	 */
	public static String rawFile = "C:\\Users\\hkang1\\Google Drive\\AHRQ\\WEBMM\\raw\\report formQi.xls";	
	public static String targetFile = "C:\\Users\\hkang1\\Google Drive\\AHRQ\\WEBMM\\raw\\UM2019_fall.txt";
	public static String SQLFile = "C:\\Users\\hkang1\\Google Drive\\AHRQ\\WEBMM\\sql\\UM_fall_2919.sql";
	...
	public static void writeSQL() throws Exception {
		...
		while((line = br.readLine()) != null) {
			...
			String sql = "INSERT INTO report_general (uni_id,initime,uptime,reporter,rstatus,formn,rname,des,link,herf_2,herf_2_f,severity_f,sir_7_f,sir_9_f,herf_7,herf_7_f) VALUES ('" + uni_id + "','" + initime + "','" + uptime + "','" + reporter + "','" + rstatus + "','" + formn + "','" + rname + "','" + CF_unstructured.polishText(des) + "','NA','" + herf_2 + "','" + herf_2_f + "','00000','000','00000000000000000000','" + herf_7 + "','" + herf_7_f + "');";
			dos.writeBytes(sql + "\r\n");
		    //-------
